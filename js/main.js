  ...
  document.addEventListener("click", (event) => {
    if (event.target.classList.contains("link-item")) {
      ...
      if (event.target.hash !== "") {
        ...
        // deactivation existing active section
...
(() => {
  ...
  tabsContainer.addEventListener("click", (event) => {
    ...
    if (
      event.target.classList.contains("tab-items") &&
      !event.target.classList.contains("active")
    ) {
      const target = event.target.getAttribute("data-target");
      //   console.log(target);
      //deactivating the existing active tab-item
      tabsContainer
        .querySelector(".active")
        .classList.remove("outer-shadow", "active");
      //activate new tab-item
      event.target.classList.add("active", "outer-shadow");
      //deactivating the existing tab-content
      aboutSection
...
(() => {
  ...
  filterContainer.addEventListener("click", (event) => {
    ...
    if (
      ...
      //deactivating exixting active 'filter-item'
      filterContainer
        .querySelector(".active")
        .classList.remove("outer-shadow", "active");
  ...
  function popupSlideShow() {
    ...
    popupImg.src = imgSrc;
    popupImg.onload = () => {
      // deactivation loader after the popupimg loaded
...
//   function slider() {
//     //deactivating exixting active slide
//     sliderContainer
